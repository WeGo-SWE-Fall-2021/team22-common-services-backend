        ...
        if '/register' in path:
            ...
            if data is not None:
                ...
                if matched:
                    ...
                    headers["Set-Cookie"] = "token=" + token + "; Domain=" + url + "; SameSite=None; Secure; HttpOnly"
            ...
            print(expires)
            headers["Set-Cookie"] = "token=; Domain=" + url + "; SameSite=None; Secure; HttpOnly; Expire=" + expires + ";"
            status = 200
            response = {
                'status': 'success',
